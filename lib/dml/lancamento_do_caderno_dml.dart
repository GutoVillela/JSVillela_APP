...
class LancamentoDoCadernoDmo implements BaseDmo{
  ...
  LancamentoDoCadernoDmo({this.idLancamento, this.dataConfirmacaoPagamento, this.dataLancamento, this.dataPagamento, this.idRede, this.nomeRede, this.pago = false, this.quantidade, this.valorUnitario});
