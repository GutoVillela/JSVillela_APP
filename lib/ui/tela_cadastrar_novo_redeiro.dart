...
class TelaCadastrarNovoRedeiro extends StatefulWidget {
  ...
  TelaCadastrarNovoRedeiro(
      {required this.tipoDeManutencao, this.redeiroASerEditado});
...
class _TelaCadastrarNovoRedeiroState extends State<TelaCadastrarNovoRedeiro> {
  ...
  void initState() {
    ...
    if (widget.tipoDeManutencao == TipoDeManutencao.alteracao && widget.redeiroASerEditado != null)
      setState(() {
        ...
        _enderecoController.text =
            widget.redeiroASerEditado!.endereco.toString();
        _enderecoDoRedeiro = widget.redeiroASerEditado!.endereco;
        _complementoController.text =
            widget.redeiroASerEditado!.endereco!.complemento!;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _chaveScaffold,
      appBar: AppBar(
          title: Text(widget.tipoDeManutencao == TipoDeManutencao.cadastro
              ...
              child: ListView(
                ...
                children: [
                              ...
                              if (localizacao != null) {
                                try {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                          content: Text(
                                              "Não foi possível obter o endereço via localização."),
                  ...
                  ListViewItemPesquisa(
                    ...
                    textoSecundario: gruposDeRedeiros == null ||
                            gruposDeRedeiros.isEmpty
                        ? "Nenhum grupo selecionado"
                        : gruposDeRedeiros.first.nomeGrupo +
                            (gruposDeRedeiros.length - 1 == 0
                                ? ""
                                : " e mais ${gruposDeRedeiros.length - 1}."),
                      ...
                      showDialog(
                          ...
                          builder: (BuildContext context) {
                            return TelaBuscaGruposDeRedeiros(
                                gruposJaSelecionados: gruposDeRedeiros);
                  ...
                  SizedBox(
                    ...
                    child: RaisedButton(
                        child: Text(
                          widget.tipoDeManutencao == TipoDeManutencao.cadastro
                              ? "Cadastrar redeiro"
                              : "Editar redeiro",
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate() &&
                            ...
                            _enderecoDoRedeiro!.complemento =
                                _complementoController.text;

                            RedeiroDmo dadosDoRedeiro = RedeiroDmo(
                                id: widget.redeiroASerEditado == null
                                    ? null
                                    : widget.redeiroASerEditado!.id,
                                nome: _nomeController.text,
                                celular: _celularController.text,
                                email: _emailController.text,
                                whatsApp: _whatsApp,
                                endereco: _enderecoDoRedeiro,
                                ativo: widget.redeiroASerEditado == null
                                    ? true
                                    : (widget.redeiroASerEditado!.ativo),
  ...
  void _finalizarCadastroDoRedeiro() {
    String mensagem = widget.tipoDeManutencao ==
            TipoDeManutencao.cadastro
  ...
  bool validarGruposDeRedeiros(BuildContext context) {
    if (gruposDeRedeiros.isNotEmpty) {
      return true;
    }
