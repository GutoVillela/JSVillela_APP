...
class ListViewItemDaSolicitacao extends StatelessWidget {
  ...
  ListViewItemDaSolicitacao({@required this.nomeRedeiro, @required this.dataDaSolicitacao, @required this.itensDaSolicitacao, this.solicitacaoAtendida});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Ink(
        color: (solicitacaoAtendida == true ? PaletaDeCor.AZUL_BEM_CLARO : PaletaDeCor.ROXO_CLARO),
        child: ListTile(
