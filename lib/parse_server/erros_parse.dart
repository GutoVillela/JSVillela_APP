/// Classe que define todos os possíveis erros recebidos do Parse Server.
class ErrosParse {
  static final Map<int, String> _erros = {
    -1: 'Erro desconhecido',
  ...
  /// Obtém a descrição do erro recebido pelo Parse Server.
  static String obterDescricao(int erro) {
    return _erros[erro] ?? "Código de erro não definido ou erro inexistente.";
  }
}
